...
static 	MATERIAL		materialField;					// マテリアル
							...
							int nNumBlockX, int nNumBlockZ, float fBlockSizeX, float fBlockSizeZ)
{
	...
	ZeroMemory(&materialField, sizeof(materialField));
	materialField.Diffuse = col;
...
BOOL RayHitFieldFog(XMFLOAT3 pos, XMFLOAT3 *HitPosition, XMFLOAT3 *Normal)
{
	XMFLOAT3 start = pos;
	XMFLOAT3 end = pos;
